...
export const STORE_TEMPLATES = {
  ...
  food: {
    pageBg: "#111111",         pageColor: "#f5f5f0",       pageMutedColor: "#888888",
    headerBg: "#0d0d0d",       headerColor: "#ffffff",     headerBorderColor: "#242424",  headerIsDark: true,
    heroBg: "linear-gradient(135deg, #c0000a 0%, #750006 100%)",
    heroColor: "#ffffff",      heroSubColor: "rgba(255,255,255,0.85)",  heroIsDark: true,
    heroBtnRadius: "50px",
    cardBg: "#1c1c1c",         cardColor: "#f5f5f0",       cardBorder: "1px solid #2d2d2d",
    cardRadius: "16px",        cardPriceColor: "#f5c842",  btnRadius: "50px",
    navItems: ["Inicio", "Combos", "Pizzas", "Bebidas", "Ofertas del día"],
    trustItems: [
      { label: "Listo en 20 min",      sub: "Caliente a tu puerta" },
      { label: "Ingredientes frescos", sub: "Del día, siempre" },
      { label: "Delivery gratis",      sub: "Desde $25.000" },
      { label: "4.9 / 5 sabor",        sub: "+5.000 pedidos semanales" },
    ],
    footerBg: "#0a0a0a",       footerColor: "#f5f5f0",     footerSubColor: "rgba(255,255,255,0.4)",
  },
  beauty: {
